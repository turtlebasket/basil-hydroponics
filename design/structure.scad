...
module structure() {
    translate([inches(-11), 0, 0]) {
        ...
        // cap top planter
        translate([0, 0, inches(12)]) rotate([0, -90, 0]) cap();

        // out pipe (top)
        translate([0, 0, inches(12)]) rotate([90, 0, -90]) pipe(1/2, 3);
        translate([inches(-3), 0, inches(12-2/3)]) rotate([0, -90, 90]) elbow(3/5);
        translate([inches(-3-2/3), 0, inches(2-2/3)]) rotate([0, 0, 90]) pipe(1/2, 10);
        translate([inches(-3-2/3), inches(-2/3), inches(2-2/3)]) rotate([0, 90, 0]) elbow(3/5);
        translate([inches(-3-2/3), inches(-2/3), 0]) rotate([90, 0, 0]) pipe(1/2, 10);

        // out pipe (bottom)
        translate([0, 0, 0]) rotate([90, 0, -90]) pipe(1/2, 3);
        translate([inches(-3), inches(-2/3), 0]) rotate([0, 0, 90]) elbow(3/5);
        translate([inches(-3-2/3), inches(-2/3), inches(2-4/3)]) rotate([90, 0, 0]) pipe(1/2, 10);
    }
}
